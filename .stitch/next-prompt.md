...
---
Generate an optional follow-up email drafting flow for the open JobPilot AI workspace.
...
**Page Structure:**
1. Sidebar navigation with Dashboard, Applications, Resume Analyzer, Interview Prep, Settings.
2. Header with current guest name and daily AI usage.
3. Application selector with overdue and upcoming follow-up status.
4. Drafting workspace for tone, context notes, and generated follow-up email.
5. Review panel that clearly says AI text must be edited before sending.
